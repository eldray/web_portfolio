...
const projects = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1581092921461-39b2f1c9ff0a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1526628953301-3e589a6a8b74?ixlib=rb-4.0.3&auto=format&fit=crop&w=1469&q=80",
...
const Projects = () => {
  return (
    <section
      id="projects"
      className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-dark dark:bg-gray-200 rounded-xl mt-12"
    >
      <div className="text-center mb-12">
        ...
        <p className="text-gray-400 dark:text-gray-600 mt-4 max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project) => (
          <div
            key={project.title}
            className="project-card bg-darker dark:bg-white rounded-xl overflow-hidden"
          >
            <div
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold mb-2 dark:text-gray-800">
                {project.title}
              </h3>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.technologies.map((tech) => (
                  <span
                    key={tech.name}
                    className={`text-xs bg-gray-800 dark:bg-gray-200 ${tech.color} px-2 py-1 rounded`}
                  >
                    {tech.name}
                  </span>
                ))}
              ...
              <div className="flex space-x-3">
                <a
                  ...
                  className="text-primary hover:text-blue-400 dark:hover:text-blue-600 transition flex items-center"
                >
                  <Github className="mr-1" /> Code
                </a>
                <a
                  href={project.links.demo}
                  className="text-secondary hover:text-green-400 dark:hover:text-green-600 transition flex items-center"
                >
      ...
      <div className="text-center mt-12">
        <a
          href="#"
          className="inline-flex items-center px-6 py-3 border border-primary text-primary dark:border-blue-600 dark:text-blue-600 hover:bg-blue-900 dark:hover:bg-blue-100 hover:bg-opacity-20 rounded-lg font-medium transition"
        >
